...
function TableHead({ className, ...props }: TableHeadProps) {
  return (
    <th
      ...
      className={cn(
        'h-12 text-left align-middle text-sm font-semibold text-tertiary-foreground opacity-[.65]',
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: TableCellProps) {
  return (
    <td
      ...
      className={cn(
        'pr-[24px] py-[12px] align-middle font-normal text-sm text-tertiary-foreground ',
        className
      )}
      {...props}
    />
